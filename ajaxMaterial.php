...
<td align="center" width="10%">
<input type="number" class="inputnumber" value="0" id="precio<?php echo $num;?>" name="precio<?php echo $num;?>" size="5" min="0.01" step="0.01"  
...
<td align="center" width="10%">
<input type="number" class="inputnumber" value="0" id="precioVenta<?php echo $num;?>" name="precioVenta<?php echo $num;?>" size="5" min="0.01" step="0.01" 
...
<td align="center" width="10%">
	<input type="number" class="inputnumber" value="0" id="precioVentaMayor<?php echo $num;?>" name="precioVentaMayor<?php echo $num;?>" size="5" min="0.01" step="0.01" 
 <?php if (obtenerValorConfiguracion($enlaceCon,7)==0){  echo "readonly";}?>  required>
<br>
