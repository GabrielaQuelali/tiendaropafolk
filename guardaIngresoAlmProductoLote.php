...
cod_proveedor,created_by,modified_by,created_date,modified_date,cod_tipo,cod_lote) 
values($codigo,$global_almacen,$tipo_ingreso,'$fecha_real','$hora_sistema','$observaciones','$nota_entrega','$nro_correlativo',1,0,0,'$nro_factura',0,0,'$proveedor','$createdBy','0','$createdDate','','$tipo','$cod_lote')";
$sql_inserta = mysqli_query($enlaceCon,$consulta);
//echo "paso 1 sql_inserta".$consulta;
if($sql_inserta==1){
   $valorExcel=0;
      ...
      for ($i = 1; $i <= $cantidad_material; $i++) {
				...
				if($cod_material!=0){
					...
					values('$codigo','$cod_material','$cantidad','$cantidad','$cod_lote','$fechaVencimiento','$precioUnitario','$precioUnitario','$costo','$costo','$costo','$costo','$precioVenta','$precioVentaMayor','$i')";
					//echo $consulta;
