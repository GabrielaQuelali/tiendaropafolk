...
sd.cantidad_unitaria, m.color, m.talla, m.cod_marca,m.codigo2,tp.contabiliza
...
if(!empty($rptMarca)){
	...
	$sql.=" order by mar.nombre asc , s.fecha asc,s.nro_correlativo asc ";
