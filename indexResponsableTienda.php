		...
		<ul>
			...
			<li><span>Salidas de Productos</span>
				<ul>
					...
					<li><a href="navegador_salidamateriales.php?tipo=1" target="contenedorPrincipal">Listado de Traspasos & Salidas</a></li>									
			...
			<li><a href="rptListadoProductos.php" target="_blank">Gestion Productos</a></li>
