...
{	var rpt_territorio,fecha_ini, fecha_fin, rpt_ver;
    ...
    if(forms.checkValidity()){
		window.open('rptCtasxPagarSucursal.php?rpt_territorio='+rpt_territorio+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
		return(true);    
	} else{
...
$fecha_rptdefaultIni="2024-01-01";
...
echo "<h1>Reporte de Cuentas x Pagar</h1><br>";
echo"<form method='post' action=''>";
	...
	echo "<tr><th align='left'>Fecha inicio:</th>";
			...
			<INPUT  type='date' class='texto' value='$fecha_rptdefaultIni' id='exafinicial' name='exafinicial' required>";
    		echo" </TD>";
	echo "</tr>";
