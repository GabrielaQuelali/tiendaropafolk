...
function envia_formulario(f){
    ...
    if(forms.checkValidity()){
		window.open('rptVentasModeloSubgrupo.php?rpt_territorio='+rpt_territorio+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'','','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
		return(true);    
	} else{
...
echo "<table align='center' class='textotit'><tr><th>Reporte de Ventas x Modelo y Subgrupo</th></tr></table><br>";
