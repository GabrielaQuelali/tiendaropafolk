...
echo "<tr><th>Cod. Analisis</th><th>Fecha Inicio Analisis</th><th>Fecha Final de Analisis</th><th>-</th>
</tr>";
$consulta = "SELECT id, fecha_inicio, fecha_final from analisis_costos order by id desc";
//echo $consulta;
...
while ($dat = mysqli_fetch_array($resp)) {
    ...
    echo "<tr>
	 ...
	 echo "	<td align='center'>
		<a target='_BLANK' href='detalleAnalisisCostosPrecios.php?idanalisis=$idanalisis'>
...
echo "<div class='divBotones'>
	<a href='rptOpAnalisisCostoPrecio.php' class='boton2' target='_BLANK'><span style='color:orange;'>Registrar Nuevo Analisis</span></a>
</div>";
